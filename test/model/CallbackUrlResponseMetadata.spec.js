...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CallbackUrlResponseMetadata', function() {
      beforeEach(function() {
        instance = new IimmpactApi.CallbackUrlResponseMetadata();
      });

      it('should create an instance of CallbackUrlResponseMetadata', function() {
        // TODO: update the code to test CallbackUrlResponseMetadata
        expect(instance).to.be.a(IimmpactApi.CallbackUrlResponseMetadata);
      });
