...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkStatusResponse', function() {
      beforeEach(function() {
        instance = new IimmpactApi.NetworkStatusResponse();
      });

      it('should create an instance of NetworkStatusResponse', function() {
        // TODO: update the code to test NetworkStatusResponse
        expect(instance).to.be.a(IimmpactApi.NetworkStatusResponse);
      });
