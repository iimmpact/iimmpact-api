...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BalanceStatementResponseMeta', function() {
      beforeEach(function() {
        instance = new IimmpactApi.BalanceStatementResponseMeta();
      });

      it('should create an instance of BalanceStatementResponseMeta', function() {
        // TODO: update the code to test BalanceStatementResponseMeta
        expect(instance).to.be.a(IimmpactApi.BalanceStatementResponseMeta);
      });
