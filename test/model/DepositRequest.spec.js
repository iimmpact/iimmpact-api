...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DepositRequest', function() {
      beforeEach(function() {
        instance = new IimmpactApi.DepositRequest();
      });

      it('should create an instance of DepositRequest', function() {
        // TODO: update the code to test DepositRequest
        expect(instance).to.be.a(IimmpactApi.DepositRequest);
      });
