...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JPJRecordsResponse', function() {
      beforeEach(function() {
        instance = new IimmpactApi.JPJRecordsResponse();
      });

      it('should create an instance of JPJRecordsResponse', function() {
        // TODO: update the code to test JPJRecordsResponse
        expect(instance).to.be.a(IimmpactApi.JPJRecordsResponse);
      });
