...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IimmpactApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.iimmpact.com
     */
    this.basePath = 'https://api.iimmpact.com'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'IIMMPACT-COGNITO': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
      'SSO': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    request.end(function(error, response) {
      if (callback) {
        ...
        var data = null;
        if (!error || (path=='/v1/topup' && error == 'Error: Bad Request')) {
          error = null;
          try {
            if(response.body.message != undefined)
            {
              returnType = 'OnlyMessageRespone';
            }
